...
const SkeletonCard = () => (
  <div className="w-96 h-60 rounded-2xl shadow border-2 border-gray-200 overflow-hidden relative animate-pulse mx-auto">
    <div className="flex h-full">
      {/* Left Side Skeleton */}
      <div className="w-2/5 bg-gray-300 flex flex-col justify-center items-center p-4 relative">
        {/* Profile Image Skeleton */}
        <div className="w-16 h-16 rounded-full bg-gray-400 mb-3"></div>
        
        {/* Rating Skeleton */}
        <div className="w-12 h-4 bg-gray-400 rounded mb-2"></div>
      ...
      {/* Right Side Skeleton */}
      <div className="w-3/5 p-4 flex flex-col justify-between bg-gray-100">
        {/* Header Skeleton */}
        <div>
      ...
      <div className="flex justify-between px-4 md:px-2">
        ...
        >
          <div className="flex items-center gap-2 relative z-10">
            ...
            <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform duration-200 text-white" />
          </div>
...
const Card = ({consultant, onBookNow}) => {
  ...
  return (
    <div className="w-full max-w-96 h-60 rounded-2xl shadow border-2 border-[#27514b] transition-all overflow-hidden duration-300 hover:shadow-lg hover:scale-[1.02] relative group mx-auto bg-[#fdf1df]">
          ...
          <div className="w-3/5 p-4 flex flex-col justify-between">
            ...
            <div>
              <div className="flex items-center gap-1 mb-1">
                <h3 className="text-lg font-bold text-[#27514b] leading-tight capitalize">
                  {fullName}
                </h3>
                <ShieldCheck className="w-5 h-5 text-emerald-600" title="Verified Consultant" />
              </div>
              <div className="inline-flex items-center gap-1 bg-[#27514b] px-2 py-1 rounded-lg text-xs font-medium text-[#fdf1df] mb-3 capitalize">
                <Badge size={10} />
                <span>Category:</span>
                {primaryCategory}
              </div>
